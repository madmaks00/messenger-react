...
export const Icons = {
  ...
  // Material Design: VolumeHigh (динамики / громкость)
  VolumeHigh: ({ size = 20, color = 'currentColor', style }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 24 24" style={style}>
  ...
  // Material Design: Microphone (микрофон / чувствительность)
  Microphone: ({ size = 20, color = 'currentColor', style }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 24 24" style={style}>
